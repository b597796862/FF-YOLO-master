...
def yolo_body(input_shape, num_classes, phi, weight_decay=5e-4):
    ...
    from nets.cusmodule import FEM,CRC,SCAM
    feat1=FEM(feat1)
    feat2 = FEM(feat2)
    feat3 = FEM(feat3)
    ...
    #将Concatenate换为CRC
    P5_upsample=CRC(P5_upsample,feat2)
    ...
    P4_upsample = CRC(P4_upsample, feat1)
    ...
    P3_downsample = CRC(P3_downsample, P4)
    ...
    P4_downsample = CRC(P4_downsample, P5)
    ...
    P3_out=SCAM(P3_out,80,80)
    P4_out=SCAM(P4_out,40,40)
    P5_out=SCAM(P5_out,20,20)
