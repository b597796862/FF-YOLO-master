...
class YOLO(object):
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        "model_path"        : 'logs/ep290-loss2.144-val_loss2.325_map9321.h5',
        "classes_path"      : 'model_data/fire_class',
        #---------------------------------------------------------------------#
        #   输入图片的大小，必须为32的倍数。
        #---------------------------------------------------------------------#
        "input_shape"       : [640, 640],
    ...
    def get_detimg_and_boxes(self, image, crop = False, count = False):
        # ---------------------------------------------------------#
        ...
        for i, c in list(enumerate(out_classes)):
            ...
            # 将标签组成(class,xmin,ymin,xmax,ymax)的形式
            kuang = (predicted_class, left, top, right, bottom)
            kuangs.append(kuang)
